...
// Fallback values — update these manually if API keeps failing
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <h3 className="text-lg font-bold text-light-text dark:text-dark-text mb-4 text-center">Contribution Activity</h3>
